...
var partnerDescriptions = map[string]string{
	...
	"smurfit-kappa": "Europe's top producer of corrugated cardboard packaging, roll paper, and bag-in-box, and the only pan-American producers of these materials.",
	"stibo-dx":      "Empowering creativity and collaboration and enabling media and enterprises to create engaging digital content.",
}
