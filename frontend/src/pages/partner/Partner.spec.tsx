...
import { partnerMock, partnerMembersMock } from '@/mocks/partner';
...
const mockFetchCalls = (spy: SpyInstance) => {
  const firstFetchResponse = {
    json: vi.fn().mockResolvedValue(partnerMock),
  };

  const secondFetchResponse = {
    json: vi.fn().mockResolvedValue(partnerMembersMock),
  };

  spy.mockResolvedValueOnce(firstFetchResponse as unknown as Promise<Response>);
  spy.mockResolvedValueOnce(
    secondFetchResponse as unknown as Promise<Response>,
  );
};
